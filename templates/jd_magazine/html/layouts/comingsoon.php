...
<html class="coming-soon" lang="<?php echo $language; ?>" dir="<?php echo $direction; ?>">
    <head>
        ...
        <?php
			...
			$theme->add_css('font-awesome.min.css, template.css, comingsoon.css');
	...
	<body>
		<div class="container">
				<div class="row">
					<div class="col-lg-6">
					<?php if($theme->count_modules('coming-soon-images')) : ?>
						<div class="coming-soon-images">
							<jdoc:include type="modules" name="coming-soon-images" style="sp_xhtml" />
						</div>
					<?php endif; ?>
					</div>
					<div class="col-lg-6">
