            ...
            'attr' => array(
                'general' => array(
                    ...
                    'front_text' => array(
                        ...
                        'std' => '<i class="fa fa-signal" style="font-size:25px;background-color:#fff;display:inline-block;color:#007BF8;width:60px;height:60px;line-height:60px;border-radius: 50%;"></i><h2>Product Design</h2>'
                    ),
                    'flip_text' => array(
                        'type' => 'textarea',
