...
SpAddonsConfig::addonConfig(
	array(
		...
		'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_SOUNDCLOUD'),
		'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_SOUNDCLOUD_DESC'),
		'category'=>'Media',
		'attr'=>array(
			'general' => array(
				...
				'embed'=>array(
					'type'=>'textarea',
					'title'=>JText::_('COM_SPPAGEBUILDER_ADDON_SOUNDCLOUD_EMBED'),
					'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_SOUNDCLOUD_EMBED_DESC'),
