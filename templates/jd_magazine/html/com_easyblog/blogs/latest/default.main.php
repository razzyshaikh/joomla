	...
	<div class="eb-post-content">
		...
		<div class="eb-post-head no-overflow">
			...
			<div class="eb-post-headline">
				<h2 itemprop="name headline" class="eb-placeholder-link-title">
			...
			?>
			<div class="eb-post-headline">
				<h2 itemprop="name headline" class="eb-post-title-tweet">
			...
			<div class="eb-post-meta text-muted">
				...
				<div class="eb-post-date">
					...
					<time class="eb-meta-date" itemprop="datePublished" content="<?php echo $post->getDisplayDate($this->params->get('post_date_source', 'created'))->format(JText::_('DATE_FORMAT_LC4'));?>">
						<?php echo $post->getDisplayDate($this->params->get('post_date_source', 'created'))->format(JText::_('F d, Y')); ?>
					</time>
				</div>
				<?php } ?>
			...
			<?php if ($post->hasReadmore() && $this->params->get('post_readmore', true)) { ?>
				<div class="col-md-6">
					<div class="eb-post-more mt-15">
						<a class="btn btn-default" href="<?php echo $post->getPermalink();?>"><i class="fa fa-file-text-o" aria-hidden="true"></i> &nbsp;<?php echo JText::_('COM_EASYBLOG_READ_MORE');?></a>
					</div>
				</div>
			<?php } ?>
