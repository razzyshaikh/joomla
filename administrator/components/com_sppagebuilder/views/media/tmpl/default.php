...
<div id="sp-pagebuilder-media-manager" class="sp-pagebuilder-admin<?php echo (count($this->items)) ? '': ' sp-pagebuilder-media-manager-empty'; ?> clearfix" style="position: relative;">
